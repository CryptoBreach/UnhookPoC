...
namespace DInvoke.DynamicInvoke
{
    ...
    public class Native
    {
        ...
        public delegate bool CreateProcessA(
            ...
            ref DInvoke.Data.Win32.WinNT.ProcessThreadsAPI._STARTUPINFOEX lpStartupInfoEx,
            out DInvoke.Data.Win32.WinNT.ProcessThreadsAPI._PROCESS_INFORMATION lpProcessInformation);
        ...
        public static bool initializeProcThreadAttributeList(IntPtr lpAttributeList, int dwAttributeCount, ref IntPtr lpSize)
        {
            ...
            var result = (bool)DInvoke.DynamicInvoke.Generic.DynamicAPIInvoke("kernel32.dll", "InitializeProcThreadAttributeList", typeof(InitializeProcThreadAttributeList), ref parameters);
        ...
        public static bool updateProcThreadAttribute(IntPtr lpAttributeList, IntPtr attribute, IntPtr lpValue)
        {
            ...
            var result = (bool)DInvoke.DynamicInvoke.Generic.DynamicAPIInvoke("kernel32.dll", "UpdateProcThreadAttribute", typeof(UpdateProcThreadAttribute), ref parameters);
        ...
        public static bool deleteProcThreadAttributeList(IntPtr lpAttributeList)
        {
            ...
            var result = (bool)DInvoke.DynamicInvoke.Generic.DynamicAPIInvoke("kernel32.dll", "DeleteProcThreadAttributeList", typeof(DeleteProcThreadAttributeList), ref parameters);

            return result;
        }
        public static Data.Native.NTSTATUS NtAlertResumeThread(
            IntPtr threadHandle,
            uint suspendCount)
        {
            ...
            Data.Native.NTSTATUS retValue = (Data.Native.NTSTATUS)Generic.DynamicAPIInvoke(@"ntdll.dll", @"NtAlertResumeThread",
                typeof(DELEGATES.NtAlertResumeThread), ref funcargs);
        ...
        public struct DELEGATES
        {
            ...
            public delegate bool CreateProcessA(
                ...
                IntPtr lpEnvironment,
                string lpCurrentDirectory,
                ref Data.Win32.WinNT.ProcessThreadsAPI._STARTUPINFOEX lpStartupInfoEx,
                out Data.Win32.WinNT.ProcessThreadsAPI._PROCESS_INFORMATION lpProcessInformation);
